...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Activisme belguim">
        <meta name="author" content="Tim Joosten">

        <title>Activisme BE | Index</title>

        <script src="https://use.fontawesome.com/4000f7ff4c.js"></script>
    ...
    <body class="loading" data-spy="scroll">
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li><a href="#">Pages</a>
                            <ul>
                                ...
                                <li><a href="event.html">Event single</a></li>
        ...
        <header class="topslider">
            ...
            <section class="slidertexthide slidertext startAnimation animated" data-animate="fadeInUp">
                <div class="slidertextinner">
                    <img src="assets/images/people2aicon.png" alt=""/>
                    <h1>People</h1>
                    <h2>Activism HTML Template</h2>
                </div>
            </section>
        </header>
            ...
            <div class="container">
                <div class="row">
                    <section class="col-lg-12 underslider startAnimation animated" data-animate="fadeInUp">
                        <h3>Activism - Activism HTML Template</h3>
                        <h4>Lorem quiserem auctor bibend uctor em quiser bibendum auctor bibend bibendum auctor bibend</h4>
                    </section>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="services">
                    <div class="row servicecolumn">
                        <!-- one column -->
                        <div class="col-sm-4 servicecolumnone startAnimation animated" data-animate="slideInLeft">
                            <a href="javascript:;"><img src="assets/images/people1icon.png" alt=""/></a>
                            <h4><span>Goal One</span></h4>
                            <p>Sed non neque elit. Sed ut imperdiet nisi. Sed nisi proin condimentum fermentum nibhquise vel
                                velit auctor aliquet. Aenean solli citudin.
                            </p>
                        </div>
                        <!-- one column end-->
                        <!-- one column -->
                        <div class="col-sm-4 servicecolumnone startAnimation animated" data-animate="fadeInUp">
                            <a href="javascript:;"><img src="assets/images/people2icon.png" alt=""/></a>
                            <h4><span>Goal Two</span></h4>
                            <p>Sed non neque elit. Sed ut imperdiet nisi. Sed nisi proin condimentum fermentum nibhquise vel
                                velit auctor aliquet. Aenean solli citudin.
                            </p>
                        </div>
                        ...
                        <div class="col-sm-4 servicecolumnone startAnimation animated" data-animate="slideInRight">
                            <a href="javascript:;"><img src="assets/images/people3icon.png" alt=""/></a>
        ...
        <section class="wrapper100percent section2">
            ...
            <div class="container">
                ...
                <div class="row startAnimation animated" data-animate="fadeInUp">
                    <!-- events -->
                    <div class="col-sm-8 eventswrapper">
                        <!-- one event -->
                        <div class="oneevent">
                            ...
                            <div class="eventstext">
                                ...
                                <p>Aenean solli citudin nibhquise vel velit auctor alique lorem ipsum dolor sit amet...
                                </p>
                                <a class="eventslink" href="event.html">click to see event <i
                        ...
                        <div class="oneevent">
                            ...
                            <div class="eventstext">
                                <h4>Event Three</h4>
                                <ul>
                                    <li>Place: <b>London</b></li>
                                    <li>Time: <b>12:00 AM</b></li>
                                </ul>
                                <p>Aenean solli citudin nibhquise vel velit auctor alique lorem ipsum dolor sit ame...
                                </p>
                                <a class="eventslink" href="event.html">click to see event <i
                                            class="fa fa-chevron-right"></i></a>
                            </div>
                    ...
                    <!-- events end -->
                    <div class="col-sm-4">
                        <h5><span>Join Us!</span></h5>
                        <p>Sed non neque elit. Sed ut imperdiet nisi. Sed nisi proin condimentum fermentum nibhquise vel velit
                            auctor aliquet. Aenean solli citudin.
                        </p>
                        <p>Sed non neque elit. Sed ut imperdiet nisi. Sed nisi proin condimentum fermentum nibhquise vel velit
                            auctor aliquet. Aenean solli citudin.
                        </p>
                        ...
                        <p> Fermentum nibhquise vel velit auctor aliquet. Aenean solli citudin.
                        </p>
                        <a class="btn btn-5 btn-5a icon-chevron-right" href="event_list.html"><span>see more events</span></a>
                    </div>
                    <!-- col-sm-4 end -->
                </div>
                <!-- row end -->
        ...
        <section class="wrapper100percent section1" id="3">
            ...
            <div class="container startAnimation animated" data-animate="fadeInUp">
                <div class="row bloghomepage" id="owl-demo1">
                    ...
                    <div class="col-lg-12">
                        <div class="item">
                            <img src="assets/images/4.jpg" alt="picture"/>
                            <div class="owl-theme-inner">
                                ...
                                <div class="owl-theme-inner-text">
                                    <h4>Post One</h4>
                                    <p>Donec orci arcu, varius at bibendum ac, pulvinar quis lorem ipsum dolor...
                                    </p>
                                    <a href="">more</a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="item">
                            <img src="assets/images/5.jpg" alt="picture"/>
                            <div class="owl-theme-inner">
                                <div class="homeblogmeta">
                                    <p>By: <a href=""> John Doe</a></p>
                                    <p class="no-border"><a href="">18 Aug 2014</a></p>
                    ...
                    <div class="col-lg-12">
                        <div class="item">
                            <img src="assets/images/6.jpg" alt="picture"/>
                            <div class="owl-theme-inner">
                                <div class="homeblogmeta">
                                    <p>By: <a href=""> John Doe</a></p>
                                    <p class="no-border"><a href="">18 Aug 2014</a></p>
                    ...
                    <div class="col-lg-12">
                        <div class="item">
                            <img src="assets/images/7.jpg" alt="picture"/>
                            <div class="owl-theme-inner">
                                <div class="homeblogmeta">
                                    <p>By: <a href=""> John Doe</a></p>
                                    <p class="no-border"><a href="">18 Aug 2014</a></p>
                ...
                <div class="row marginbottom1">
                    <div class="col-lg-12 textcenter">
                        <a class="btn btn-2 btn-2b" href="blogindex.html"><span>see more news</span></a>
                    </div>
                </div>
            </div>
            <!-- container end -->
                ...
                <div class="row startAnimation animated" data-animate="fadeInUp">
                    <div class="col-sm-6">
                        ...
                        <div class="onelist">
                            ...
                            <div class="eventstext">
                                <h4>Feature One</h4>
                                <p>Aenean solli citudin nibhquise vel velit auctor aliquet. Aenean solli citudin nibhquise vel
                    ...
                    <!-- col-sm-6 end -->
                    <div class="col-sm-6">
                        <h5><span>Subheadline</span></h5>
                        <p>Sed non neque elit. Sed ut imperdiet nisi. Sed nisi proin condimentum fermentum nibhquise vel velit
                            auctor aliquet. Aenean solli citudin.
                            Sed non neque elit. Sed ut imperdiet nisi. Sed nisi proin condimentum fermentum nibhquise vel velit
                            auctor aliquet. Aenean solli citudin.
                            Nibhquise vel velit auctor aliquet. Aenean solli citudin.
                        </p>
                        <p>Sed non neque elit. Sed non neque elit. SSed non neque elit. Sed non neque elit. Sed ut imperdiet
                            nisi. Sed nisi proin condimentum fermentum nibhquise vel velit auctor aliquet. Aenean solli citudin.
                        </p>
        ...
        <section class="wrapper100percent section3">
            <div class="section3inner">
                ...
                <div class="row">
                    <div class="col-lg-12 quotewrapper">
                        <i class="fa fa-quote-right"></i>
                        <ul class="bxtestimonials animated" id="bxtestimonials" data-animate="fadeInUp">
                            <li><p>Sed ut imperdiet nisi. Proin condimentum fermentum nunc. Etiam pharetra, erat sed fermentum
                                    feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Suspendisse in orci enim.
                                </p>
                                <p class="cite"><span>John Doe,</span> Company Name</p>
                            </li>
                            <li><p>Sed ut imperdiet nisi. Proin condimentum fermentum nunc. Etiam pharetra, erat sed fermentum
                                    feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Suspendisse in orci enim.
                                </p>
                                <p class="cite"><span>Jane Doe,</span> Company Name</p>
                            </li>
                            <li>
                                <p>Sed ut imperdiet nisi. Proin condimentum fermentum nunc. Etiam pharetra, erat sed fermentum
                ...
                <div class="grid">
                    <figure class="effect-sadie">
                        ...
                        <figcaption>
                            ...
                            <a class='imagepopup' href="../assets/images/4.jpg"></a>
                        </figcaption>
                    </figure>
                    <figure class="effect-sadie">
                        ...
                        <figcaption>
                            <h2>Image <span>One</span></h2>
                            <p>Lorem ipsum dolor sit amet lorem ipsum dolor.</p>
                            <a class='imagepopup' href="../assets/images/5.jpg"></a>
                        </figcaption>
                    </figure>
                    <figure class="effect-sadie">
                        ...
                        <figcaption>
                            <h2>Image <span>One</span></h2>
                            <p>Lorem ipsum dolor sit amet lorem ipsum dolor.</p>
                            <a class='imagepopup' href="../assets/images/6.jpg"></a>
                        </figcaption>
                    </figure>
                    <figure class="effect-sadie">
                        ...
                        <figcaption>
                            <h2>Image <span>One</span></h2>
                            <p>Lorem ipsum dolor sit amet lorem ipsum dolor.</p>
                            <a class='imagepopup' href="../assets/images/7.jpg"></a>
                        </figcaption>
                    </figure>
                    <figure class="effect-sadie">
                        ...
                        <figcaption>
                            <h2>Image <span>One</span></h2>
                            <p>Lorem ipsum dolor sit amet lorem ipsum dolor.</p>
                            <a class='imagepopup' href="../assets/images/8.jpg"></a>
                        </figcaption>
                    </figure>
                    <figure class="effect-sadie">
                        ...
                        <figcaption>
                            <h2>Image <span>One</span></h2>
                            <p>Lorem ipsum dolor sit amet lorem ipsum dolor.</p>
                            <a class='imagepopup' href="../assets/images/9.jpg"></a>
                        </figcaption>
                    </figure>
                    <figure class="effect-sadie">
                        ...
                        <figcaption>
                            <h2>Image <span>One</span></h2>
                            <p>Lorem ipsum dolor sit amet lorem ipsum dolor.</p>
                            <a class='imagepopup' href="../assets/images/10.jpg"></a>
                        </figcaption>
                    </figure>
                    <figure class="effect-sadie">
                        ...
                        <figcaption>
                            <h2>Image <span>One</span></h2>
                            <p>Lorem ipsum dolor sit amet lorem ipsum dolor.</p>
                            <a class='imagepopup' href="../assets/images/11.jpg"></a>
                        </figcaption>
                    </figure>
                </div>
                <!-- grid end -->
            ...
            <div class="container startAnimation animated" data-animate="fadeInUp">
                <div class="row">
                    ...
                    <div class="onelist col-lg-6">
                        ...
                        <div class="eventstext">
                            <h4>Question One</h4>
                            <p>Aenean solli citudin nibhquise vel velit auctor aliquet. Aenean solli citudin nibhquise vel velit
                                auctor aliquet.
                            </p>
                        </div>
                    </div>
        ...
        <section class="wrapper100percent section1" id="7">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-4 address">
                            ...
                            <ul>
                                <li><h4>Address</h4>
                                    <p>111 Street Address 111 City, AAA 154679</p></li>
                            </ul>
                        </div>
                        <div class="col-sm-4 address">
                            ...
                            <ul>
                                <li><h4>Phone</h4>
                                    <p><a href="callto:123">+1 (123) / 123 - 12331</a></p></li>
                            </ul>
                        </div>
                        <div class="col-sm-4 address">
                            <i class="fa fa-clock-o"></i>
                            <ul>
                                <li><h4>Working Time</h4>
                                    <p>Mon - Fri: 08:00 - 17:00 H 00 - 24h</p></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="wrapper100percent map">
                ...
                <iframe src="https://maps.google.com/maps?sll=42.3232039,-71.1423464&amp;sspn=0.0974788,0.1757965&amp;q=new+yourk+near+Brookline,+MA&amp;ie=UTF8&amp;hq=new+york&amp;hnear=Brookline,+Norfolk+County,+Massachusetts&amp;t=m&amp;ll=42.343748,-71.142702&amp;spn=0.081827,0.222714&amp;output=embed">
                </iframe>
            </div>
            <div class="wrapper100percent">
                <div class="container startAnimation animated" data-animate="fadeInUp">
                                    ...
                                    <div>
                                        <div id="main">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="contact2">
                                                    <p><input type="text" placeholder="Your e-mail address" name="email"
                                                              id="email" class="commentfield"/>
                                                    </p>
                                                </div>
                                                <div class="contact2">
                                            ...
                                            <div class="col-sm-6">
                                                <p><textarea name="comments" placeholder="Your message" id="comments" rows="12"
                                                             cols="5" class="textarea"></textarea>
                                                </p>
                                                <div class="buttoncontactwrapper">
                                                    <p><input type="submit" name="submit" class="buttoncontact" id="submit"
                                                              value="send message"/>
                                                    </p>
                                                </div>
                                            </div>
        ...
        <footer class="bottom">
            ...
            <div class="wrapper100percent copyrightwrapper">
                <div class="copyright wrapper100percent">
                    ...
                    <p>&copy; 2014 <a href="http://themeforest.net/user/rayoflightt?ref=rayoflightt">Rayoflightthemes</a> All
                        rights reserved</p>
                </div>
            </div>
        </footer>
